...
const stages = ref<Stage[]>([
  { id: 'blah-id-0', title: 'Backlog', position: 0n },
  { id: 'blah-id-1', title: 'To Do', position: 1n },
  { id: 'blah-id-2', title: 'In Progress', position: 2n },
  { id: 'blah-id-3', title: 'Review required', position: 3n },
  { id: 'blah-id-4', title: 'Reviewed', position: 4n },
  { id: 'blah-id-5', title: 'Done', position: 5n },
])
</script>
